...
<body class="index-page">
            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li><a href="{{ route('guest.pendaftar_bantuan.index') }}">Pendaftar Bantuan</a></li>
                        <li><a href="{{ route('guest.verifikasi_lapangan.index') }}">Verifikasi Lapangan</a></li>
                    </ul>
    ...
    <a href="https://wa.me/6281234567890?text=Halo%20BinaDesa!" class="whatsapp-float" target="_blank" rel="noopener">
